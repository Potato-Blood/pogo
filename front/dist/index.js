...
import { FrogBuilder } from './Frog';
import { Event, MouseEvent, VoiceEvent, PRESS_RELEASE } from './generated/event_pb.d';
const buildFrog = (p) => {
...
export const sketch = (p) => {
    ...
    const handleHatEvent = (hatEvent) => { };
    const startWebsocket = (ip, port, backoff) => {
        console.log("Attempting to connect to websocket");
        var ws = new WebSocket(`ws://${ip}:${port}`);
        ws.onmessage = function (msgEvent) {
            let event = msgEvent.data;
